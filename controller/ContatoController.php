...
class ContatoController
{
    ...
    public function respEmail()
    {
        ...
        */
        ...
        $assuntoEmail = 'Contato Etec Caieiras: '. $_POST["nome"];
        $TextoEmail = '<h3>Retorno do contato feito no site Etec Caieiras</h3><p><b>Nome contato:</b> '.$_POST["nome"].'<br><b>E-mail do contato:</b> '.$_POST["email"].'<br><b>Mensagem do contato:</b> '.$_POST["mensagem"].' </p><p><b>Resposta da Etec:</b></p><p>'.$_POST["respMensagem"];
        $QuemRecebe = $_POST["email"];;//quem irá receber
        $QuemEnvia = 'no-replay@eteccaieiras.projetowebx.com.br';//o seu email para envio
        $SenhaQuemEnvia = 'Etec#279';//senha de quem está enviando
        $NomeQuemEnvia = 'Contato Etec Caieiras';
        $porta = 465;
