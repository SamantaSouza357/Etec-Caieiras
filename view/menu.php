<nav class="navbar navbar-expand-lg navbar-dark bg-secondary">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Etec Caieiras</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="<?php echo URL;?>cadastro-documento"><i class="fa fa-save"></i> Cadastrar</a></li>
            <li><a class="dropdown-item" href="<?php echo URL;?>consulta-documento"><i class="fa fa-search"></i> Consultar</a></li>
          </ul>
        </li>
        <li class="nav-item">
