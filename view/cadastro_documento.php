    ...
    <div class="container">
        <div class="row mt-3 px-2">
            <div class="col-sm-8 rounded border mx-auto p-3 shadow">
                ...
                <form action="<?php echo URL;?>enviar-documento" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="texto" id="texto" class="form-control" placeholder="Informe a descrição do documento"></textarea>
                    </div>
