    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            <div class="col-sm-10 rounded border mx-auto p-3 shadow">
                <h5 class="text-center">Consulta de Noticias</h5>
                        ...
                        <tbody>
                            ...
                            foreach($dadosNoticia as $value)
                            {
                                ...
                                $data = $value->data;
                                    ...
                                    echo "<tr>
                                        <th scope='row'>$value->cod_noticia</th>
                                        <td>$value->categoria</td>
                                        <td>$value->titulo</td>
                                        <td class='linha-tabela'>$value->conteudo</td>
                                        <td>" . date('d/m/Y', strtotime($data)) . "</td>
                                        <td> <img src= 'imagens/$value->imagem ' width='50px' height='50px'></td>
                                     
                                        <td>$value->nm_usuario</td>
                                        <td>
                                            <a href='". URL ."excluir-noticia/$value->cod_noticia' onclick='return confirm(\"Tem certeza?\")' class='btn btn-outline-danger btn-sm'><i class='fa fa-trash'></i></a>
                                            <a href='". URL ."editar-noticia/$value->cod_noticia' class='btn btn-outline-warning btn-sm'><i class='fa fa-edit'></i> </a>
                                        </td>
                                    </tr>";
                                }
